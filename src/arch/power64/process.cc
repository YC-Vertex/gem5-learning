...
void
Power64Process::argsInit(int intSize, int pageSize)
{
    ...
    if (elfObject) {
        ...
        auxv.emplace_back(M5_AT_PAGESZ, Power64ISA::PageBytes);
...
const std::vector<int> Power64Process::SyscallABI::ArgumentRegs = {
    3, 4, 5, 6, 7, 8
};
