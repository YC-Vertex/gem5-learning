#include "arch/power64/linux/process.hh"

#include "arch/power64/isa_traits.hh"
#include "arch/power64/linux/linux.hh"
...
class Power64LinuxObjectFileLoader : public Process::Loader
{
  public:
    Process *
    load(ProcessParams *params, ::Loader::ObjectFile *obj_file) override
    {
        if (obj_file->getArch() != ::Loader::Power64)
            return nullptr;
        ...
        return new Power64LinuxProcess(params, obj_file);
    }
};

Power64LinuxObjectFileLoader loader;
...
SyscallDescTable<Power64Process::SyscallABI> Power64LinuxProcess::syscallDescs = {
    {  0, "syscall" },
    {  1, "exit", exitFunc },
    {  2, "fork" },
    {  3, "read", readFunc<Power64Linux> },
    {  4, "write", writeFunc<Power64Linux> },
    {  5, "open", openFunc<Power64Linux> },
    {  6, "close", closeFunc },
    {  7, "waitpid" }, //???
    {  8, "creat" },
    {  9, "link" },
    ...
    { 11, "execve" },
    { 12, "chdir" },
    { 13, "time", timeFunc<Power64Linux> },
    { 14, "mknod" },
    { 15, "chmod", chmodFunc<Power64Linux> },
    { 16, "lchown", chownFunc },
    { 17, "break", brkFunc }, //???
    { 18, "unused#18" }, //???
    { 19, "lseek", lseekFunc },
    ...
    { 41, "dup", dupFunc },
    { 42, "pipe" },
    { 43, "times", timesFunc<Power64Linux> },
    { 44, "prof" },
    { 45, "brk", brkFunc },
    { 46, "setgid" },
    ...
    { 52, "umount2" },
    { 53, "lock" },
    { 54, "ioctl", ioctlFunc<Power64Linux> },
    { 55, "fcntl", fcntlFunc },
    { 56, "mpx" },
    { 57, "setpgid" },
    { 58, "ulimit" },
    ...
    { 104, "setitimer" },
    { 105, "getitimer" },
    { 106, "stat",  statFunc<Power64Linux> },
    { 107, "lstat" },
    { 108, "fstat", fstatFunc<Power64Linux> },
    { 109, "unused#109" },
    { 110, "iopl" },
    { 111, "vhangup" },
    { 112, "idle", ignoreFunc },
    ...
    { 144, "msync" },
    { 145, "readv" },
    { 146, "writev", writevFunc<Power64Linux> },
    { 147, "getsid" },
    { 148, "fdatasync" },
    { 149, "sysctl" },
    { 150, "mlock" },
    ...
    { 191, "getrlimit" },
    { 192, "mmap2", mmapFunc<Power64Linux> },
    { 193, "truncate64" },
    { 194, "ftruncate64", ftruncate64Func },
    { 195, "stat64", stat64Func<Power64Linux> },
    { 196, "lstat64", lstat64Func<Power64Linux> },
    { 197, "fstat64", fstat64Func<Power64Linux> },
    { 198, "lchown" },
...
Power64LinuxProcess::Power64LinuxProcess(ProcessParams * params,
        ::Loader::ObjectFile *objFile) :
    Power64Process(params, objFile)
{}

void
Power64LinuxProcess::initState()
{
    Power64Process::initState();
}

void
Power64LinuxProcess::syscall(ThreadContext *tc)
{
    Power64Process::syscall(tc);
